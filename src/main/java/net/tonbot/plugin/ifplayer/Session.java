...
class Session {
	...
	public Session(SessionKey sessionKey, String name, Story story, SaveFile saveFile, IChannel channel,
			OnSavedCallback onSavedCallback, ScreenStateRenderer screenStateRenderer) {
